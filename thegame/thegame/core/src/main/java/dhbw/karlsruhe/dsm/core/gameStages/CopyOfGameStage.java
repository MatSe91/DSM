 ...
 */
public class CopyOfGameStage extends Stage {

	private static final Vector2 GRAVITY_VECTOR = new Vector2(0, -555);
	...
	public CopyOfGameStage(OrthographicCamera camera, Level currentLevel, Player player) {
		super();
	...
	public void act(float delta) {
		...
		player.setPosition(player.getPhysicalBody().getPosition().x, player.getPhysicalBody().getPosition().y);
	}
